    ...
    public partial class AddModels : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserDepartment", x => new { x.DepartmentsDepartmentId, x.UsersId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationUserDepartment_Department_DepartmentsDepartmentId",
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "PriorityId", "Description", "Name" },
                values: new object[,]
                {
                    { 1, "Critical, business impact", "P1" },
                    { 2, "Needs prompt attention", "P2" },
                    { 3, "Standard priority", "P3" },
                    { 4, "Minor issue, no urgency", "P4" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Ticket has been created", "Open" },
                    { 2, "Work is underway", "In Progress" },
                    { 3, "Ticket is waiting on external", "Waitng" },
                    { 4, "Issue has been addressed", "Resolved" },
                    { 5, "Ticket is finalized", "Closed" }
                });
